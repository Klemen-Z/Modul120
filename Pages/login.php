    ...
    <body>
        <div class="m-auto mt-[5%] p-2 min-h-fit min-w-fit rounded-lg w-[30rem] h-[80%] bg-slate-800">
            <div class="text-gray-300 min-h-fit min-w-fit w-full h-full">
                <form class="flex flex-cols-1 flex-rows-4 flex-col h-full items-center gap-y-12">
                    ...
                    <div class="grow shrink bottom-2 pt-[70%]">
                        <Button type="submit" class="cursor-pointer rounded-md p-1 my w-24 h-12 text-lg font-semibold ml-auto mr-auto text-center bg-slate-500 text-gray-300 inset-x-0 bottom-0">Log in</Button>
